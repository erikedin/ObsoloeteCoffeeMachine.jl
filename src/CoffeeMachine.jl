...
cupisinthemachine(machine::Machine, cup::Cup) = machine.cup = Nullable(cup)

fillcup!(machine::Machine, liquid::Symbol, amount::Float64) = get(machine.cup)[liquid] = amount
